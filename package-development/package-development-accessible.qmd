...
#|  A typical workflow:
#|  1. Edit code.
#|  2. Load code with load_all().
#|  3. Run code (or skip to 3).
#|  4. Write/edit tests.
#|  5. Run tests with test().
#|  6. Go back to 1 (edit code) and repeat.
#|  7. Write/edit Roxygen documentation.
#|  8. Rebuild docs and NAMESPACE with document().
#|  9. Check complete package with check().
#|  10. git commit.
#|  11. git push.
...
```{=html}
<!----
A potential alternative way to describe the image instead
of alt-text, but need to have it collapsed visually, but
expanded for a screen reader. Can probably use css from 
the IDE cheatsheet...

::: {.callout-note collapse="true" appearance="simple"}
## Expand to view a typical workflow {aria-hidden="true"}
