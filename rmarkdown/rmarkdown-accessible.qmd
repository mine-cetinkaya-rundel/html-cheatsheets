...
![](rmarkdown-images/rmarkdown-images/source-editor.png){fig-align="center"}
...
![](rmarkdown-images/visual-editor.png){fig-align="center"}
...
![](rmarkdown-images/rendered-output.png){fig-align="center"}
...
| ```                                         |                                                                           |
+---------------------------------------------+---------------------------------------------------------------------------+
| ```                                         | ![R Markdown logo](rmarkdown-images/rmarkdown-logo.png){alt="R Markdown logo" width="300"} |
| ![Caption](image.png)                       |                                                                           |
|                                             |                                                                           |
| or                                          |                                                                           |
|                                             |                                                                           |
