...
will render as "Built with 4.1.0" in the output file.
...
Other table packages include **flexible**, **gt**, and **kableExtra**.
...
+-------------------------------------------------+--------------------------------------------------------------------------+
|     End a line with two spaces to               | End a line with two spaces to                                            |
|     start a new paragraph.                      |                                                                          |
|                                                 | start a new paragraph.                                                   |
+-------------------------------------------------+--------------------------------------------------------------------------+
|     Also end a line with a backslash\           | Also end a line with a backslash                                         |
|     to make a new line.                         |                                                                          |
|                                                 | to make a new line.                                                      |
+-------------------------------------------------+--------------------------------------------------------------------------+
...
|     2. item 2                                   |                                                                          |
|       - item 2a (indent 1 tab)                  | 2.  item 2                                                               |
|       - item 2b                                 |                                                                          |
|                                                 |     -   item 2a                                                          |
|                                                 |                                                                          |
|                                                 |     -   item 2b                                                          |
+-------------------------------------------------+--------------------------------------------------------------------------+
|     <link url>                                  | <https://posit.co/>                                                      |
+-------------------------------------------------+--------------------------------------------------------------------------+
|     [This is a link.](link url)                 | [This is a link.](https://posit.co/)                                     |
+-------------------------------------------------+--------------------------------------------------------------------------+
|     [This is another link.][id].                | [This is another link.](https://posit.co/)                               |
|                                                 |                                                                          |
|     At the end of the document:                 |                                                                          |
|     [id]: link url                              |                                                                          |
+-------------------------------------------------+--------------------------------------------------------------------------+
|     ![Caption](image.png)                       | TODO Image                                                               |
|                                                 |                                                                          |
|     or                                          |                                                                          |
|                                                 |                                                                          |
|     ![Caption](image.png)                       |                                                                          |
...
+-------------------------------------------------+--------------------------------------------------------------------------+
|     equation: $e^{i \pi} + 1 = 0$               | equation: $e^{i \pi} + 1 = 0$                                            |
+-------------------------------------------------+--------------------------------------------------------------------------+
...
|     |1    |1   |1      |1     |                 | |     1 | 1    | 1       |   1    |                                      |
|                                                 |                                                                          |
|     Table: Caption text, example rendered table | : Caption text, example rendered table.                                  |
+-------------------------------------------------+--------------------------------------------------------------------------+
...
\*PDFs and Beamer slides require LaTeX, use `tinytex::install_tinytx()`
...
Also see Shiny Prerendered for better performance. <https://rmarkdown.rstudio.com/authoring_shiny_prerendered.HTML>.
