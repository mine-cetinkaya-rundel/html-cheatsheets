...
-   `str_view_all(string, pattern, match = NA)`: View HTML rendering of all regex matches. Also `str_view()` to see only the first match.
...
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
| `\\s`       | `\s`           | any whitespace\                   | `see("\\s")`       | ``` html                                                          |
|             |                | (`\S` for non-whitespaces)        |                    | abc< >ABC< >123<\t>.!?\(){}<\n>                                   |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
| `\\d`       | `\d`           | any digit\                        | `see("\\d")`       | ``` html                                                          |
|             |                | (`\D` for non-digits)             |                    | abc ABC <1><2><3>\t.!?\(){}\n                                     |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
| `\\w`       | `\w`           | any word character\               | `see("\\w")`       | ``` html                                                          |
|             |                | (`\W` for non-word characters)    |                    | <a><b><c> <A><B><C> <1><2><3>\t.!?\(){}\n                         |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
| `\\b`       | `\b`           | word boundaries                   | `see("\\b")`       | ``` html                                                          |
|             |                |                                   |                    | <>abc<> <>ABC<> <>123<>\t.!?\(){}\n                               |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:digit:]`^1^ | digits                            | `see("[:digit:]")` | ``` html                                                          |
|             |                |                                   |                    | abc ABC <1><2><3>\t.!?\(){}\n                                     |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:alpha:]`^1^ | letters                           | `see("[:alpha:]")` | ``` html                                                          |
|             |                |                                   |                    | <a><b><c> <A><B><C> 123\t.!?\(){}\n                               |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:lower:]`^1^ | lowercase letters                 | `see("[:lower:]")` | ``` html                                                          |
|             |                |                                   |                    | <a><b><c> ABC 123\t.!?\(){}\n                                     |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:upper:]`^1^ | uppercase letters                 | `see("[:upper:]")` | ``` html                                                          |
|             |                |                                   |                    | abc <A><B><C> 123\t.!?\(){}\n                                     |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:alnum:]`^1^ | letters and numbers               | `see("[:alnum:]")` | ``` html                                                          |
|             |                |                                   |                    | <a><b><c> <A><B><C> <1><2><3>\t.!?\(){}\n                         |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:punct:]`^1^ | punctuation                       | `see("[:punct:]")` | ``` html                                                          |
|             |                |                                   |                    | abc ABC 123\t<.><!><?><\><(><)><{><}>\n                           |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:graph:]`^1^ | letters, numbers, and punctuation | `see("[:graph:]")` | ``` html                                                          |
|             |                |                                   |                    | <a><b><c> <A><B><C> <1><2><3>\t<.><!><?><\><(><)><{><}>\n         |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:space:]`^1^ | space characters (i.e. `\s`)      | `see("[:space:]")` | ``` html                                                          |
|             |                |                                   |                    | abc< >ABC< >123<\t>.!?\(){}<\n>                                   |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `[:blank:]`^1^ | space and tab (but not new line)  | `see("[:blank:]")` | ``` html                                                          |
|             |                |                                   |                    | abc< >ABC< >123<\t>.!?\(){}\n                                     |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
|             | `.`            | every character except a new line | `see(".")`         | ``` html                                                          |
|             |                |                                   |                    | <a><b><c>< ><A><B><C>< ><1><2><3><\t><.><!><?><\><(><)><{><}><\n> |
|             |                |                                   |                    | ```                                                               |
+-------------+----------------+-----------------------------------+--------------------+-------------------------------------------------------------------+
...
+============+==============+=================+======================================+
| `ab|d`     | or           | `alt("ab|d")`   | ``` html                             |
|            |              |                 | <ab>c<d>e                            |
|            |              |                 | ```                                  |
+------------+--------------+-----------------+--------------------------------------+
| `[abe]`    | one of       | `alt("[abe]"`   | ``` html                             |
|            |              |                 | <a><b>cd<e>                          |
|            |              |                 | ```                                  |
+------------+--------------+-----------------+--------------------------------------+
| `[^abe]`   | anything but | `alt("[^abe]")` | ``` html                             |
|            |              |                 | ab<c><d>e                            |
|            |              |                 | ```                                  |
+------------+--------------+-----------------+--------------------------------------+
| `[a-c]`    | range        | `alt("[a-c]")`  | ``` html                             |
|            |              |                 | <a><b><c>de                          |
|            |              |                 | ```                                  |
+------------+--------------+-----------------+--------------------------------------+
...
|            |                 |                | (highlighted characters are in \<\>) |
+============+=================+================+======================================+
| `^a`       | start of string | `anchor("^a")` | ``` html                             |
|            |                 |                | <a>aa                                |
|            |                 |                | ```                                  |
+------------+-----------------+----------------+--------------------------------------+
| `a$`       | end of string   | `anchor("a$")` | ``` html                             |
|            |                 |                | aa<a>                                |
|            |                 |                | ```                                  |
+------------+-----------------+----------------+--------------------------------------+
...
|             |                 |                   | (highlighted characters are in \<\>) |
+=============+=================+===================+======================================+
| `a(?=c)`    | followed by     | `look("a(?=c)")`  | ``` html                             |
|             |                 |                   | b<a>cad                              |
|             |                 |                   | ```                                  |
+-------------+-----------------+-------------------+--------------------------------------+
| `a(?!c)`    | not followed by | `look("a(?!c)")`  | ``` html                             |
|             |                 |                   | bac<a>d                              |
|             |                 |                   | ```                                  |
+-------------+-----------------+-------------------+--------------------------------------+
| `(?<=b)a`   | preceded by     | `look("(?<=b)a")` | ``` html                             |
|             |                 |                   | b<a>cad                              |
|             |                 |                   | ```                                  |
+-------------+-----------------+-------------------+--------------------------------------+
| `(?<!b)a`   | not preceded by | `look("(?<!b)a")` | ``` html                             |
|             |                 |                   | bac<a>d                              |
|             |                 |                   | ```                                  |
+-------------+-----------------+-------------------+--------------------------------------+
...
|             |                     |                   | (highlighted characters are in \<\>) |
+=============+=====================+===================+======================================+
| `a?`        | zero or one         | `quant("a?")`     | ``` html                             |
|             |                     |                   | <>.<a><>.<a><a><>.<a><a><a><>        |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
| `a*`        | zero or more        | `quant("a*")`     | ``` html                             |
|             |                     |                   | <>.<a><>.<aa><>.<aaa><>              |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
| `a+`        | one or more         | `quant("a+")`     | ``` html                             |
|             |                     |                   | .<a>.<aa>.<aaa>                      |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
| `a{n}`      | exactly `n`         | `quant("a{2}")`   | ``` html                             |
|             |                     |                   | .a.<aa>.<aa>a                        |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
| `a{n, }`    | `n` or more         | `quant("a{2,}")`  | ``` html                             |
|             |                     |                   | .a.<aa>.<aaa>                        |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
| `a{n, m}`   | between `n` and `m` | `quant("a{2,4}")` | ``` html                             |
|             |                     |                   | .a.<aa>.<aaa>                        |
|             |                     |                   | ```                                  |
+-------------+---------------------+-------------------+--------------------------------------+
...
|             |                 |                  | (highlighted characters are in \<\>) |
+=============+=================+==================+======================================+
| `(ab|d)e`   | sets precedence | `alt("(ab|d)e")` | ``` html                             |
|             |                 |                  | abc<de>                              |
|             |                 |                  | ```                                  |
+-------------+-----------------+------------------+--------------------------------------+
...
+=============+================+======================+===========================================+======================================+
| `\\1`       | `\1` (etc.)    | first () group, etc. | `ref("(a)(b)\\2\\1")`                     | ``` html                             |
|             |                |                      |                                           | <abba>ab                             |
|             |                |                      |                                           | ```                                  |
+-------------+----------------+----------------------+-------------------------------------------+--------------------------------------+
